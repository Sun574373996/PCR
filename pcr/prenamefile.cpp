...
PRenameFile::PRenameFile(QWidget *parent) : Popups(parent)
{
    name_edit =new Label;
...
void PRenameFile::paintEvent(QPaintEvent *event)
{
    QWidget::paintEvent(event);
    qDebug()<<"painter PRenameFile";
    /*
    Q_UNUSED(event);

    QPainter painter(this);
    painter.drawPixmap(this->rect(),QPixmap(":/image/background/rename_page.jpg"),QRect());
    */
}
